...
import { Calendar, Users, TrendingUp, ChevronRight, Download, Upload, BookOpen, Check, Building2 } from "lucide-react";
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex -space-x-3 overflow-hidden">
                      {isEventVisit(visit) ? (
                        <div className="w-10 h-10 rounded-xl bg-violet-600 ring-2 ring-violet-700 flex items-center justify-center flex-shrink-0 relative shadow-md">
                          <Building2 className="w-4 h-4 text-white/80 absolute top-0.5 left-0.5" strokeWidth={2.2} />
                          <span className="text-[13px] font-black text-white tracking-tight leading-none">JW</span>
                        </div>
                      ) : isCouple ? (
                        <>
